...
<StatusBar />
<AppBar title="Planos" sub="{plansStore.data?.length ?? 0} no total" />
	...
	<div class="mz-body mz-body--pad" style="gap:12px">
		...
		<div class="grid gap-3 lg:grid-cols-2">
			{#each filtered as plan}
				...
				<a href="/merchant/plans/{plan.id}" class="mz-row" style="text-decoration:none;color:inherit;border-radius:18px;border:1px solid var(--line);box-shadow:var(--shadow-card);padding:14px">
